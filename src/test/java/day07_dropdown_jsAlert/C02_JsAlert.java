...
public class C02_JsAlert {
    ...
    public void test01() throws InterruptedException {
        ...
        String actualAlertyazisi = driver.switchTo().alert().getText();//switchTo()=geçiş yap
        ...
        driver.switchTo().alert().accept();//accept=kabul
    }
    ...
    public void test02() throws InterruptedException {
        ...
        Thread.sleep(3000);
        driver.switchTo().alert().dismiss();//dissmiss=redetmek
